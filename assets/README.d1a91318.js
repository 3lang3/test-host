var C=Object.defineProperty,B=Object.defineProperties;var D=Object.getOwnPropertyDescriptors;var l=Object.getOwnPropertySymbols;var f=Object.prototype.hasOwnProperty,A=Object.prototype.propertyIsEnumerable;var a=(t,r,n)=>r in t?C(t,r,{enumerable:!0,configurable:!0,writable:!0,value:n}):t[r]=n,d=(t,r)=>{for(var n in r||(r={}))f.call(r,n)&&a(t,n,r[n]);if(l)for(var n of l(r))A.call(r,n)&&a(t,n,r[n]);return t},c=(t,r)=>B(t,D(r));import{a as u,j as e,F as h,r as v}from"./main.fe5cd3cd.js";import{z as i,r as w,G as o}from"./index.ec4c84af.js";import{S as x,a as y}from"./PlayCircleO.db0d11d2.js";import{S}from"./Replay.ce8dca91.js";var s=()=>u(i,{time:30*60*60*1e3});const b={code:`import React from 'react';
...
export default () => {
  return <CountDown time={30 * 60 * 60 * 1000} />;
};`}},key:"count-down-demo",meta:{title:"\u57FA\u7840\u7528\u6CD5"}};var F=()=>u(i,{time:30*60*60*1e3,format:"DD \u5929 HH \u65F6 mm \u5206 ss \u79D2"});const k={code:`import React from 'react';
import { CountDown } from 'react-vant';
export default () => {
...
export default () => {
  return <CountDown time={30 * 60 * 60 * 1000} format="DD \u5929 HH \u65F6 mm \u5206 ss \u79D2" />;
};`}},key:"count-down-demo-1",meta:{title:"\u81EA\u5B9A\u4E49\u683C\u5F0F"}};var m=()=>u(i,{time:30*60*60*1e3,millisecond:!0,format:"HH:mm:ss:SS"});const N={code:`import React from 'react';
import { CountDown } from 'react-vant';
export default () => {
...
}`}},key:"count-down-demo-3",meta:{title:"\u81EA\u5B9A\u4E49\u6837\u5F0F"}};var p=()=>{const t=v.exports.useRef();return e(h,{children:[u(i,{ref:t,time:3e3,millisecond:!0,format:"ss:SSS",autoStart:!1,onFinish:()=>w.info("\u5012\u8BA1\u65F6\u7ED3\u675F")}),u("br",{}),e(o,{columnNum:3,children:[u(o.Item,{icon:u(x,{}),text:"\u5F00\u59CB",onClick:()=>t.current.start()}),u(o.Item,{icon:u(y,{}),text:"\u6682\u505C",onClick:()=>t.current.pause()}),u(o.Item,{icon:u(S,{}),text:"\u91CD\u7F6E",onClick:()=>t.current.reset()})]})]})};const R=`import React, { useRef } from 'react';
...
`,g={code:R,lang:"tsx",dependencies:{react:{type:"NPM",value:"17.0.2"},"react-vant":{type:"NPM",value:"2.0.0-alpha.29"},"@react-vant/icons":{type:"NPM",value:"0.0.6"},"index.tsx":{type:"FILE",value:`import React, { useRef } from 'react';
import { CountDown, Grid, Toast } from 'react-vant';
import { PauseCircleO, PlayCircleO, Replay } from '@react-vant/icons';
import type { CountDownInstance } from 'react-vant';
