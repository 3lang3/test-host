...
};`,lang:"jsx",dependencies:{react:{type:"NPM",value:"17.0.2"},"react-vant":{type:"NPM",value:"2.0.0-alpha.29"},"index.jsx":{type:"FILE",value:`import { useState } from 'react';
import { Slider, Toast } from 'react-vant';
...
export default () => {
  ...
  return <Slider range value={value} onChange={setValue} onChangeAfter={onChangeAfter} />;
};`}},key:"slider-demo-1",meta:{title:"\u53CC\u6ED1\u5757"}};var p=()=>{const[t,u]=i.exports.useState(10);return e(o,{min:-50,max:50,value:t,onChange:u,onChangeAfter:d=>c.info(`\u5F53\u524D\u503C\uFF1A${d}`)})};const P={code:`import { useState } from 'react';
import { Slider, Toast } from 'react-vant';
...
};`}},key:"slider-demo-2",meta:{title:"\u6307\u5B9A\u9009\u62E9\u8303\u56F4"}};var A=()=>{const[t,u]=i.exports.useState(10);return e(o,{disabled:!0,value:t,onChange:u,onChangeAfter:d=>c.info(`\u5F53\u524D\u503C\uFF1A${d}`)})};const $={code:`import { useState } from 'react';
import { Slider, Toast } from 'react-vant';
...
export default () => {
  ...
  return <Slider disabled value={value} onChange={setValue} onChangeAfter={onChangeAfter} />;
};`}},key:"slider-demo-3",meta:{title:"\u7981\u7528"}};var m=()=>{const[t,u]=i.exports.useState(10);return e(o,{step:10,value:t,onChange:u,onChangeAfter:d=>c.info(`\u5F53\u524D\u503C\uFF1A${d}`)})};const M={code:`import { useState } from 'react';
import { Slider, Toast } from 'react-vant';
...
export default () => {
  ...
  return <Slider step={10} value={value} onChange={setValue} onChangeAfter={onChangeAfter} />;
};`}},key:"slider-demo-4",meta:{title:"\u6307\u5B9A\u6B65\u957F"}};var f=()=>{const[t,u]=i.exports.useState(10);return e(o,{barHeight:4,activeColor:"#ee0a24",value:t,onChange:u,onChangeAfter:d=>c.info(`\u5F53\u524D\u503C\uFF1A${d}`)})};const N={code:`import { useState } from 'react';
import { Slider, Toast } from 'react-vant';
...
};`}},key:"slider-demo-5",meta:{title:"\u81EA\u5B9A\u4E49\u6837\u5F0F"}};var E=()=>{const[t,u]=i.exports.useState(10);return e(o,{button:e("div",{className:"custom-slider-button",children:t}),value:t,onChange:u,onChangeAfter:d=>c.info(`\u5F53\u524D\u503C\uFF1A${d}`)})};const k={code:`import { useState } from 'react';
import { Slider, Toast } from 'react-vant';
...
};`,lang:"tsx",dependencies:{react:{type:"NPM",value:"17.0.2"},"react-vant":{type:"NPM",value:"2.0.0-alpha.29"},"index.tsx":{type:"FILE",value:`import { useState } from 'react';
import { Slider, Toast } from 'react-vant';
