...
`,G={code:T,lang:"tsx",dependencies:{react:{type:"NPM",value:"17.0.2"},"react-vant":{type:"NPM",value:"2.0.0-alpha.29"},"index.tsx":{type:"FILE",value:`import React, { useState } from 'react';
import { Field } from 'react-vant';
...
`}},key:"field-type",meta:{title:"\u81EA\u5B9A\u4E49\u7C7B\u578B",card:!0}};var f=()=>u(s.Group,{children:[e(l,{label:"\u6587\u672C",value:"\u8F93\u5165\u6846\u53EA\u8BFB",readonly:!0}),e(l,{label:"\u6587\u672C",value:"\u8F93\u5165\u6846\u5DF2\u7981\u7528",disabled:!0})]});const j={code:`import React from 'react';
...
};`}},key:"field-demo-1",meta:{title:"\u7981\u7528\u8F93\u5165\u6846",card:!0}};var g=()=>{const[t,d]=n.exports.useState(""),[r,a]=n.exports.useState("");return e(h,{children:u(s.Group,{children:[e(l,{value:t,onChange:d,label:"\u6587\u672C",leftIcon:e(B,{}),rightIcon:e(V,{}),placeholder:"\u663E\u793A\u56FE\u6807",onClickLeftIcon:()=>C.info("\u5DE6\u4FA7\u56FE\u6807\u70B9\u51FB"),onClickRightIcon:()=>C.info("\u53F3\u4FA7\u56FE\u6807\u70B9\u51FB")}),e(l,{value:r,onChange:a,clearable:!0,label:"\u6587\u672C",leftIcon:e(B,{}),placeholder:"\u663E\u793A\u6E05\u9664\u56FE\u6807"})]})})};const W=`import { ShopO, WarningO } from '@react-vant/icons';
...
`,O={code:W,lang:"tsx",dependencies:{"@react-vant/icons":{type:"NPM",value:"0.0.6"},react:{type:"NPM",value:"17.0.2"},"react-vant":{type:"NPM",value:"2.0.0-alpha.29"},"index.tsx":{type:"FILE",value:`import { ShopO, WarningO } from '@react-vant/icons';
import React, { useState } from 'react';
import { Cell, Field, Toast } from 'react-vant';
...
`,q={code:$,lang:"tsx",dependencies:{react:{type:"NPM",value:"17.0.2"},"react-vant":{type:"NPM",value:"2.0.0-alpha.29"},"index.tsx":{type:"FILE",value:`import React, { useState } from 'react';
import { Cell, Field } from 'react-vant';
...
`,J={code:H,lang:"tsx",dependencies:{react:{type:"NPM",value:"17.0.2"},"react-vant":{type:"NPM",value:"2.0.0-alpha.29"},"index.tsx":{type:"FILE",value:`import React, { useState } from 'react';
import { Field } from 'react-vant';
...
`,Z={code:Y,lang:"tsx",dependencies:{react:{type:"NPM",value:"17.0.2"},"react-vant":{type:"NPM",value:"2.0.0-alpha.29"},"index.tsx":{type:"FILE",value:`import React, { useRef } from 'react';
import { Field, Button } from 'react-vant';
import type { FieldInstance } from 'react-vant';
