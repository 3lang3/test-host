...
`,J={code:Q,lang:"tsx",dependencies:{react:{type:"NPM",value:"17.0.2"},"react-vant":{type:"NPM",value:"2.0.0-alpha.29"},"index.tsx":{type:"FILE",value:`import React from 'react';
import { Button, Field, Form } from 'react-vant';
...
`,X={code:K,lang:"tsx",dependencies:{react:{type:"NPM",value:"17.0.2"},"react-vant":{type:"NPM",value:"2.0.0-alpha.29"},"index.tsx":{type:"FILE",value:`import React from 'react';
import { Button, Field, Toast, Form } from 'react-vant';
...
`,re={code:ue,lang:"tsx",dependencies:{react:{type:"NPM",value:"17.0.2"},"react-vant":{type:"NPM",value:"2.0.0-alpha.29"},"index.tsx":{type:"FILE",value:`import React from 'react';
import {
  Button,
  Checkbox,
  Field,
...
`}},key:"form-type",meta:{title:"\u8868\u5355\u9879\u7C7B\u578B"}};var _=()=>e(i,{onFinish:n=>{console.log(n)},footer:e("div",{style:{margin:"16px 16px 0"},children:e(C,{round:!0,nativeType:"submit",type:"primary",block:!0,children:"\u63D0\u4EA4"})}),children:e($.Group,{inset:!0,children:e(i.List,{name:"users",initialValue:[{name:"react-vant",age:"1"}],children:(n,{add:r,remove:l})=>u(f,{children:[n.map((o,d)=>u("div",{className:"form-list-item",children:[u("h6",{children:["\u7528\u6237",d+1,":"]}),u("div",{className:"form-list-item__control",children:[e(i.Item,{label:"\u59D3\u540D",name:[o.name,"name"],rules:[{type:"string",min:2,max:6,message:"\u59D3\u540D\u6700\u5C11\u4E24\u4E2A\u5B57\uFF0C\u6700\u591A6\u4E2A\u5B57"}],children:e(a,{placeholder:"\u8BF7\u8F93\u5165\u7528\u6237\u59D3\u540D"})}),e(i.Item,{label:"\u5E74\u9F84",name:[o.name,"age"],rules:[{type:"number",message:"\u8BF7\u8F93\u5165\u6570\u5B57",transform:h=>Number(h)}],children:e(a,{placeholder:"\u8BF7\u8F93\u5165\u7528\u6237\u5E74\u9F84",rightIcon:e(H,{onClick:()=>l(d)})})})]})]},o.key)),e("div",{style:{padding:10},children:e(C,{round:!0,block:!0,plain:!0,icon:e(W,{}),size:"small",onClick:()=>r(),children:"\u65B0\u589E\u7528\u6237"})})]})})})});const te=`import React from 'react';
...
`,ne={code:te,lang:"tsx",dependencies:{react:{type:"NPM",value:"17.0.2"},"react-vant":{type:"NPM",value:"2.0.0-alpha.29"},"@react-vant/icons":{type:"NPM",value:"0.0.6"},"index.tsx":{type:"FILE",value:`import React from 'react';
import { Button, Cell, Field, Form } from 'react-vant';
import { AddO, Delete } from '@react-vant/icons';
import './style.less';
