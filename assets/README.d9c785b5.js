...
`,f={code:x,lang:"tsx",dependencies:{react:{type:"NPM",value:"17.0.2"},"react-vant":{type:"NPM",value:"2.0.0-alpha.29"},"index.tsx":{type:"FILE",value:`import React, { useState } from 'react';
import { ActionSheet, Cell } from 'react-vant';
...
`,k={code:S,lang:"tsx",dependencies:{react:{type:"NPM",value:"17.0.2"},"react-vant":{type:"NPM",value:"2.0.0-alpha.29"},"index.tsx":{type:"FILE",value:`import React, { useState } from 'react';
import { ActionSheet, Cell } from 'react-vant';
...
`}},key:"action-sheet-status",meta:{title:"\u9009\u9879\u72B6\u6001",card:!0}};var m=()=>{const[i,t]=h.exports.useState(!1);return u(o,{children:[e(d,{title:"\u9009\u9879\u72B6\u6001",isLink:!0,onClick:()=>t(!0)}),e(c,{visible:i,onCancel:()=>t(!1),children:e("div",{style:{padding:"16px 16px 160px"},children:"\u5185\u5BB9"})})]})};const y=`import React, { useState } from 'react';
import { ActionSheet, Cell } from 'react-vant';
...
`,V={code:y,lang:"tsx",dependencies:{react:{type:"NPM",value:"17.0.2"},"react-vant":{type:"NPM",value:"2.0.0-alpha.29"},"index.tsx":{type:"FILE",value:`import React, { useState } from 'react';
import { ActionSheet, Cell } from 'react-vant';
